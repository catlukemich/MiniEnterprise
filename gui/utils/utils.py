...
from gui.utils.Font import Font
from gui.utils.Font import Glyph
...
def load_font(fnt_path, atlas_path):
    font_atlas = load_image(atlas_path)
...
def map_range(input_value, original_range_min, original_range_max, target_range_min, target_range_max):
